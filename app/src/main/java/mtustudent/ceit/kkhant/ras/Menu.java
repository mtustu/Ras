...
public class Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        databaseReference = database.getReference().child("test1");
    ...
    public void OnClick(View view) {
        ...
        final String time = t3.getText().toString().trim();

        if(!TextUtils.isEmpty(name) && !TextUtils.isEmpty(price) && !TextUtils.isEmpty(time))
        {
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Menu.this,"Upload Complete",Toast.LENGTH_LONG).show();
                        ...
                        mDatabaseUser.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                newPost.child("estTime").setValue(time);
